...
image::logicalView/logical_view.jpg[Vista Lógica, width=800, align=center]



==== Descripción de los Paquetes Lógicos (Capas)
...
image::conceptModel/conceptModel.jpg[Diagrama de clases conceptual, width=900, align=center]
...
==== Reglas de Negocio Explícitas en el Modelo
