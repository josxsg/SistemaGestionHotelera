...
==== Attribute-Driven Design (ADD): Derivando la Arquitectura
...
===== Iteraciones de Diseño y Decisiones Arquitectónicas (ADD)
...
==== CBSE (Cheesman & Daniels): El Proceso de Especificación
...
===== Fase 2: Interacción de Componentes
...
===== Fase 3: Especificación de Componentes
