...
=== 1. Proceso de Creación de Reserva (Transaccionalidad Estricta)
...
=== 2. Proceso de Consulta de Disponibilidad (Lectura Optimizada)
...
=== 3. Proceso de Check-In (Orquestación de Estado)
