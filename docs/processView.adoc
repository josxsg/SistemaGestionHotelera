...
image::sequenceDiagrams/RealizarReservacion.png[align=center, title="Diagrama de Secuencia: Creación de Reserva Transaccional"]
...
image::sequenceDiagrams/RegistrarCheckIn.png[align=center, title="Diagrama de Secuencia: Registrar Check-In"]
